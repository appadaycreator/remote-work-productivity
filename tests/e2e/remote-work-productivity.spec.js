...
const SVC_URL = "https://appadaycreator.com/remote-work-productivity/";
const SVC_NAME = "テレワーク生産性診断";

test.describe("テレワーク生産性診断 - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("remote-work-productivity");
